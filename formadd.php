				...
				<div class="order">
                    ...
                    <div class="form">
                        <form id="order-form" action="" method="post" enctype="multipart/form-data">
                            ...
                            <input type="text" id="product-name" name="nama" required autocomplete="off">
                
                            <label for="product-price">Harga Produk:</label>
                            <input type="number" id="product-price" name="harga" autocomplete="off" placeholder="Masukkan Harga Tanpa Rp" required>
                
                            <label for="product-des">Deskripsi Produk:</label>
							<textarea id="product-des" rows="10" name="deskripsi" placeholder="Masukkan Deskripsi Menarik tentang Produk"></textarea>
                            <!-- <input type="text" id="product-des" name="deskripsi" autocomplete="off" required> -->
                            
                            <label for="product-stok">Masukkan Stok Produk:</label>
                            <input type="number" id="product-stok" name="stok" autocomplete="off" required>
                            ...
                            <button type="submit" name="add" class="btn-download">
                                <i class='bx bx-add-to-queue'></i>
                                <span class="text">Konfirmasi Tambah Produk</span>
							</button>
                          </form>
                    </div>
